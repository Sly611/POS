...
class StaffListView(APIView):
    """
    API view to retrieve the list of staff members.

    Methods:
        get(request):
            Retrieves all staff members from the database, serializes the data, 
    ...
    Returns:
        Response: A Response object containing serialized staff data with an HTTP 200 status.
    """
    @staff_list_schema
...
class StaffCreateView(APIView):
    ...
    Methods:
        post(request):
            Validates and saves the provided staff data, 
    ...
    Returns:
        Response: A Response object containing the serialized staff data if 
        successful with an HTTP 201 status, or an error message with an HTTP 400 status.
    """
    @staff_create_schema
    def post(self, request):
        ...
        Args:
            request (HttpRequest): The HTTP request object containing staff data.

        Returns:
            Response: 
                - A Response object containing the serialized staff data if successful with an HTTP 201 status.
                - A Response object containing an error message with an HTTP 400 status if the input is invalid.
        """
...
class StoreCreateApiView(APIView):
    ...
    @expense_category_create_schema
    def post(self, request):
        """
        Create a new store.
...
class ExpenseCategoryDetailView(APIView):
    ...
    """
    @expense_category_detail_get_schema
    def get(self, request, pk):
        """
        Retrieve a single expense category by its primary key.
    ...
    @expense_category_detail_put_schema
    def put(self, request, pk):
        """
